...
<<<<<<< HEAD
            ...
            de saber "dónde es arriba", así que usan el ángulo estimado por el
            detector de pose. Se aplica antes de restar el wrist como origen:
            como la rotación es lineal, R(v) - R(w) == R(v - w), así que el
